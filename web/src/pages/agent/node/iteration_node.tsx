...
interface IIterationNode {
  name?: string;
  label?: string;
}

interface IIterationStartNode {
  name?: string;
  label?: string;
}
...
export function IterationNode({
  ...
  return (
    ...
    >
      ...
      ></Handle>
      <div className={classNames('p-2 bg-white rounded-t-[10px] absolute w-full top-[-60px] left-[-0.3px]', styles.iterationHeader, {
...
export function IterationStartNode({
  ...
  return (
    <section
      className={classNames('bg-white p-2 rounded-xl', {
