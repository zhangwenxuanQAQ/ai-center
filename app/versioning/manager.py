    ...
    def _init_default_modules(self):
        ...
        default_modules = {
            ...
            'api': {'name': 'API接口', 'description': 'API服务分类、配置与接口管理', 'required': False,
                    'api_prefixes': ['/api_server', '/code_script'], 'frontend_routes': ['/toolkit', '/api/setting/:id'],
                    'menu_keys': ['api'], 'database_tables': ['api_server_category', 'api_server', 'api', 'code_script', 'code_script_category'], 'dependencies': []},
