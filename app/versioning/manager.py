...
class VersionManager:
    ...
    def _init_default_modules(self):
        ...
        default_modules = {
            ...
            'code_script': {'name': '代码脚本', 'description': '代码脚本管理、校验与测试执行', 'required': False,
                            'api_prefixes': ['/code_script'], 'frontend_routes': ['/toolkit'],
                            'menu_keys': ['code_script'], 'database_tables': ['code_script', 'code_script_category'], 'dependencies': []},
            ...
            'agent': {'name': '智能体', 'description': '智能体管理（hermes_agent 引擎）', 'required': False,
                      'api_prefixes': ['/agent'], 'frontend_routes': ['/agents', '/agent/setting/:id', '/hermes/agent/:name'],
            ...
            'skill': {'name': 'SKILL管理', 'description': 'AGENT SKILL插件管理与文件目录', 'required': False,
                      'api_prefixes': ['/skill', '/skill_category'], 'frontend_routes': ['/skills', '/skill/setting/:id'],
                      'menu_keys': ['skill'], 'database_tables': ['skill', 'skill_category'], 'dependencies': []},
        }
