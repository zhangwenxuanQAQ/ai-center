...
class KnowledgebaseDocumentCategory(SoftDeleteModel):
    ...
    chunk_method = CharField(max_length=50, null=True, verbose_name="切片方法")
    chunk_config = TextField(null=True, verbose_name="切片配置JSON")
...
class KnowledgebaseDocument(SoftDeleteModel):
    ...
    task_progress_message = TextField(null=True, verbose_name="文档解析进度消息")
