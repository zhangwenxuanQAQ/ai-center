"""
数据库迁移：修改chat_message表中extra_content字段类型为LONGTEXT
"""
...
def migrate():
    """
    执行迁移：将extra_content字段从TEXT改为LONGTEXT
    """
    print("开始执行迁移：修改chat_message表extra_content字段类型...")
    ...
    try:
        with db.atomic():
            ...
            if result[0] > 0:
                ...
                print("字段 extra_content 不是 TEXT 类型或已修改，跳过")
