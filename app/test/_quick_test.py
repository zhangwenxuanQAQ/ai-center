...
from app.core.knowledgebase.rag.nlp.rag_tokenizer import RagTokenizer, tokenizer, tokenize
print('✓ rag_tokenizer OK')
test_tokens = tokenize("这是一个测试文本")
print('Test tokens:', test_tokens[:50])

from app.core.knowledgebase.rag.svr.task_executor import TaskExecutor, task_executor
